...
function LayoutContent({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-stone-50/40 via-stone-50/50 to-white dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-900 dark-luxury:from-blue-950 dark-luxury:via-slate-950 dark-luxury:to-slate-950">
      ...
      <header className="md:hidden fixed top-0 left-0 right-0 z-40 bg-white/95 dark:bg-neutral-900/95 dark-luxury:bg-blue-950/95 backdrop-blur-lg border-b border-stone-200/50 dark:border-neutral-800 dark-luxury:border-slate-600/30">
        <div className="flex items-center justify-between px-4 py-3.5">
          ...
          <button
            ...
            className="p-2 hover:bg-stone-100 dark:hover:bg-neutral-800 rounded-lg"
          >
            {isDark ? <Sun className="w-5 h-5 text-slate-300" /> : <Moon className="w-5 h-5 text-stone-600" />}
          </button>
        </div>
      </header>
        ...
        {isSidebarOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed left-0 top-0 bottom-0 w-72 bg-white dark:bg-neutral-900 dark-luxury:bg-blue-950 shadow-2xl z-50 md:hidden"
            >
              <div className="p-6">
      ...
      {/* Desktop Sidebar */}
      <aside className="hidden md:flex fixed left-0 top-0 bottom-0 w-64 bg-white/80 dark:bg-neutral-900/80 dark-luxury:bg-blue-950/80 backdrop-blur-sm border-r border-stone-200/50 dark:border-neutral-800 dark-luxury:border-slate-600/30 flex-col">
        <div className="p-6 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-serif text-neutral-900 dark:text-stone-100 dark-luxury:text-slate-200 tracking-tight">
              Daily Essence
            </h1>
          ...
          <button
            ...
            className="p-2 hover:bg-stone-100 dark:hover:bg-neutral-800 rounded-lg"
          >
            {isDark ? <Sun className="w-4 h-4 text-slate-300" /> : <Moon className="w-4 h-4 text-stone-600" />}
          </button>
        </div>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? 'bg-gradient-to-r from-stone-100 to-stone-100 dark:from-neutral-800 dark:to-neutral-800 dark-luxury:from-slate-800 dark-luxury:to-slate-800 text-slate-700 dark:text-slate-300 border border-stone-200 dark:border-neutral-700 dark-luxury:border-slate-600/50'
                    : 'text-stone-700 dark:text-stone-400 dark-luxury:text-slate-400 hover:bg-stone-50 dark:hover:bg-neutral-800 dark-luxury:hover:bg-blue-900/50'
                )}
              >
        ...
        <div className="p-4 m-4 bg-gradient-to-br from-stone-50 to-stone-50 dark:from-neutral-800 dark:to-neutral-800 dark-luxury:from-slate-800 dark-luxury:to-blue-900 rounded-lg border border-stone-200/50 dark:border-neutral-700 dark-luxury:border-slate-600/40 shadow-sm">
         <p className="text-xs text-slate-700 dark:text-slate-300 dark-luxury:text-slate-300 font-medium uppercase tracking-widest">Self-Care Reminder</p>
