...
function LayoutContent({ children, currentPageName }) {
    ...
    return (
      <div className="min-h-screen bg-neutral-50">
        <button
          ...
          className="fixed top-4 left-4 z-50 p-2 bg-white/20 backdrop-blur-sm rounded-full hover:bg-white/30 transition-colors"
        >
          <X className="w-5 h-5" />
        </button>
        {children}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-stone-50/40 via-stone-50/50 to-white">
      ...
      {/* Mobile Header */}
      <header className="md:hidden fixed top-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-xl border-b border-stone-200/50">
        ...
        {isSidebarOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed left-0 top-0 bottom-0 w-72 bg-white shadow-2xl z-50 md:hidden backdrop-blur-xl"
            >
              <div className="p-6">
                    ...
                    return (
                      <Link
                        ...
                        className={cn(
                          ...
                          isActive
                            ? 'bg-gradient-to-r from-amber-900/30 to-amber-800/20 text-slate-700 border border-stone-200/50'
      ...
      {/* Desktop Sidebar */}
      <aside className="hidden md:flex fixed left-0 top-0 bottom-0 w-64 bg-white/80 backdrop-blur-xl border-r border-stone-200/50 flex-col">
        <div className="p-6">
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? 'bg-gradient-to-r from-amber-900/30 to-amber-900/15 text-slate-700 border border-stone-200'
        ...
        <div className="p-4 m-4 bg-gradient-to-br from-amber-900/20 to-amber-900/10 rounded-lg border border-stone-200/50 shadow-sm backdrop-blur-sm">
         <p className="text-xs text-slate-700 font-medium uppercase tracking-widest">Self-Care Reminder</p>
