      ...
      <div className="max-w-2xl mx-auto px-4 py-6 pb-32">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <Button
            ...
            className="rounded-xl bg-gradient-to-r from-amber-500 to-rose-500 hover:from-amber-600 hover:to-rose-600"
          >
        ...
        <div className="space-y-12">
          {isLoading ? (
            ...
            >
              ...
              <Button
                onClick={() => setIsCreateOpen(true)}
                className="rounded-xl bg-gradient-to-r from-amber-500 to-rose-500"
              >
                <Plus className="w-4 h-4 mr-2" />
