        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto mb-12">
          {plans.map((plan, index) => (
            <motion.div
              ...
              className={`relative rounded-3xl border-2 ${plan.borderColor} dark:border-purple-500/60 transition-all duration-300 ${
                plan.highlighted 
            ...
            >
              {/* Background */}
              <div className={`absolute inset-0 bg-white/50 dark:bg-stone-500/20 dark-luxury:bg-stone-500/20 rounded-3xl -z-10`} />
