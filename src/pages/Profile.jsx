        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <Button onClick={() => setShowAddGoal(true)} className="bg-slate-700 hover:bg-slate-800 text-white dark:bg-gradient-to-r dark:from-rose-500 dark:via-rose-400 dark:to-pink-500 dark:hover:from-rose-600 dark:hover:via-rose-500 dark:hover:to-pink-600 shadow-lg gap-2">
          ...
          {isLoading ? (
            ...
            >
              ...
              <Button onClick={() => setShowAddGoal(true)} className="bg-slate-700 hover:bg-slate-800 text-white dark:bg-gradient-to-r dark:from-rose-500 dark:via-rose-400 dark:to-pink-500 dark:hover:from-rose-600 dark:hover:via-rose-500 dark:hover:to-pink-600 shadow-lg">
