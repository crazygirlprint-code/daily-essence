          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <Button
                ...
                className="gap-2 bg-slate-700 hover:bg-slate-800 dark:bg-gradient-to-r dark:from-rose-600 dark:to-pink-600 dark:hover:from-rose-700 dark:hover:to-pink-700 text-white"
              >
                {loadingInsights ? (
                  <>
              ...
              <Button onClick={() => setShowAddGoal(true)} className="bg-slate-700 hover:bg-slate-800 dark:bg-gradient-to-r dark:from-rose-600 dark:to-pink-600 dark:hover:from-rose-700 dark:hover:to-pink-700 gap-2">
