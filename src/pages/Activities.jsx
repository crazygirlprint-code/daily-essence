      ...
      <div className="max-w-3xl mx-auto px-4 py-8 pb-20">
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <Button onClick={() => setShowLogger(true)} className="bg-rose-600 hover:bg-rose-700 text-white gap-2">
        ...
        {stats.count > 0 && (
          ...
          >
            <div className="bg-stone-100/50 rounded-xl p-4 border border-stone-300">
              <p className="text-xs text-stone-600 uppercase tracking-widest mb-2">Activities</p>
              <p className="text-2xl font-serif text-rose-600">{stats.count}</p>
            </div>
            <div className="bg-stone-100/50 rounded-xl p-4 border border-stone-300">
              <p className="text-xs text-stone-600 uppercase tracking-widest mb-2">Total Time</p>
              <p className="text-2xl font-serif text-rose-600">{stats.totalMinutes}m</p>
            </div>
            <div className="bg-stone-100/50 rounded-xl p-4 border border-stone-300">
        ...
        {isLoading ? (
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            className="text-center py-16 bg-stone-100/50 rounded-2xl border border-dashed border-stone-300"
          >
            <Zap className="w-12 h-12 text-rose-400 mx-auto mb-4 opacity-50" />
            ...
            <Button onClick={() => setShowLogger(true)} className="bg-rose-600 hover:bg-rose-700 text-white">
