...
export default function Affirmations() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-rose-50 to-amber-50 dark:bg-gradient-to-br dark:from-slate-900 dark:via-purple-900/50 dark:to-slate-900 dark-luxury:bg-transparent">
