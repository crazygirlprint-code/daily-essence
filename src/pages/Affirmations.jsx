...
export default function Affirmations() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-rose-50 to-amber-50 dark:bg-gradient-to-b dark:from-purple-400 dark:to-purple-600 dark-luxury:bg-transparent">
