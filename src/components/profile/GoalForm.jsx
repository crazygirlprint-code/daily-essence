...
export default function GoalForm({ goal, onSubmit, onCancel }) {
  ...
  return (
    <motion.div
      ...
      className="bg-white dark:bg-neutral-900 dark-luxury:bg-blue-950 rounded-2xl p-6 border border-amber-200/50 dark:border-neutral-800 dark-luxury:border-amber-600/30 shadow-sm"
    >
