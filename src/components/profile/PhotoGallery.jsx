      ...
      >
        <div className="flex items-center justify-between mb-6">
          ...
          <Button
            ...
            disabled={uploading}
            size="sm"
            className="gap-2 bg-slate-700 hover:bg-slate-800 text-white dark:bg-slate-700 dark:hover:bg-slate-800"
          >
            {uploading ? (
        ...
        {photos.length === 0 ? (
          <div className="text-center py-12 border-2 border-dashed border-stone-300 rounded-xl">
            ...
            <Button
              ...
              disabled={uploading}
              size="sm"
              className="bg-slate-700 hover:bg-slate-800 text-white dark:bg-slate-700 dark:hover:bg-slate-800"
            >
