...
export default function ActivityCard({ activity, onDelete }) {
  ...
  return (
    <motion.div
      ...
      className="bg-white/50 rounded-xl p-4 border-2 border-purple-300 dark:border-purple-500/60"
    >
      ...
      <div className="space-y-2 text-sm">
        {activity.duration_minutes && (
          <p className="text-slate-700">⏱️ <span className="font-medium">{activity.duration_minutes} minutes</span></p>
        )}
