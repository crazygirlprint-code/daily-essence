  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-white dark:bg-transparent rounded-2xl p-6 max-w-md w-full max-h-[90vh] overflow-y-auto border border-stone-200 dark:border-rose-500/40 shadow-2xl"
      >
