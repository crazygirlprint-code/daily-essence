  ...
  return (
    <div className="mb-8">
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="text-stone-700 text-xs font-medium uppercase tracking-widest">{greeting.text}, {firstName}</span>
      </div>
      
      <h1 className="text-4xl font-serif text-stone-900 tracking-tight leading-tight">
        {getDateLabel(date)}
      </h1>
      
      <p className="text-stone-600 text-sm mt-1.5 uppercase tracking-widest font-light">
